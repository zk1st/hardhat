...
#[napi]
pub struct Receipt {
    inner: Arc<rethnet_eth::receipt::BlockReceipt>,
}

impl Deref for Receipt {
    type Target = rethnet_eth::receipt::BlockReceipt;
...
impl From<Arc<rethnet_eth::receipt::BlockReceipt>> for Receipt {
    fn from(inner: Arc<rethnet_eth::receipt::BlockReceipt>) -> Self {
        Self { inner }
    }
}
