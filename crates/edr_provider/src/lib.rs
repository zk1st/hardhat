...
fn handle_single_request(
    ...
    match request {
        ...
        MethodInvocation::EvmSetIntervalMining(_) => Err(ProviderError::Unimplemented(
        ...
        MethodInvocation::EvmSnapshot(()) => eth::handle_snapshot_request(data).and_then(to_json),
        ...
        MethodInvocation::Metadata(()) => hardhat::handle_metadata_request(data).and_then(to_json),
        MethodInvocation::Mine(_, _) => Err(ProviderError::Unimplemented("Mine".to_string())),
        MethodInvocation::Reset(config) => hardhat::handle_reset(data, config).and_then(to_json),
