// Parts of this code were adapted from github.com/foundry-rs/foundry and are
// distributed under its licenses:
// - https://github.com/foundry-rs/foundry/blob/42da94276892f63afefd0dc743e862b058a4b4c2/LICENSE-APACHE
// - https://github.com/foundry-rs/foundry/blob/42da94276892f63afefd0dc743e862b058a4b4c2/LICENSE-MIT
// For the original context, see https://github.com/foundry-rs/foundry/blob/42da94276892f63afefd0dc743e862b058a4b4c2/crates/evm/core/src/abi/hardhat_console.rs

use std::fmt::{self, Display, Formatter};

use alloy_sol_types::sol;
use edr_eth::HashMap;
use edr_evm::alloy_primitives::Selector;
use once_cell::sync::Lazy;

sol!(
    #[doc = "ABI for Hardhat's `console.log` function."]
    #[allow(missing_docs)]
    #[sol(abi)]
    HardhatConsole,
    "src/abi/console_log/hardhat_abi.json"
);
...
pub fn patch_hardhat_console_selector(input: &mut [u8]) {
    if let Some(selector) = console_selector(input) {
...
///
/// See [`HARDHAT_CONSOLE_SELECTOR_PATCHES`] for more details.
fn console_selector(input: &[u8]) -> Option<&'static Selector> {
